...
export function AccountDashboard({ origin, user }: { origin: string; user: { displayName: string; email: string } }) {
  ...
  return <main className="account-page">
    <nav className="account-nav"><a className="brand" href="/"><span className="brand-mark"><Boxes size={18} /></span><span>Nucleus</span></a><div><a href="/"><Plus size={15} />新建应用</a><a href="/signout-with-chatgpt?return_to=%2F"><LogOut size={15} />退出登录</a></div></nav>
