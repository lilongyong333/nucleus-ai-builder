...
async function chat(messages: ChatMessage[], maxTokens: number, signal?: AbortSignal): Promise<string> {
...
export async function createPlan(prompt: string, currentFiles?: GeneratedFiles, signal?: AbortSignal): Promise<AgentPlan> {
...
export async function buildApp(prompt: string, plan: AgentPlan, currentFiles?: GeneratedFiles, signal?: AbortSignal): Promise<{ files: GeneratedFiles; summary: string; quality: AppQualityReport }> {
